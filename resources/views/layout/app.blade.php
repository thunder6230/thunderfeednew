...
<head>
    ...
    <script src="https://thunderfeed.herokuapp.com/js/app.js"></script>
...
<body class="min-h-screen bg-gray-50 w-full h-full box-border">
    ...
    <div class="container xs:w-11/12 sm:w-10/12 md:w-9/12 lg:w-8/12 xl:w-8/12 2xl:w-8/12 pt-16 mx-auto min-h-3/4 h-5/6">
        @yield('content')
    </div>
